...
public class SignUpOne extends JFrame implements ActionListener{
    ...
    SignUpOne(){
        ...
        personaldetails.setBounds(270, 80, 400, 35);
        add(personaldetails);
        ...
        maritial.setBounds(110, 390, 200, 30);
        add(maritial);
        ...
        other.setBounds(620, 390, 90, 30);
        other.setBackground(Color.WHITE);
        add(other);        
        
        ButtonGroup marritialGroup = new ButtonGroup();
        marritialGroup.add(married);
        marritialGroup.add(unmarried);
        marritialGroup.add(other);
