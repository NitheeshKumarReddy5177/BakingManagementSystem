...
public class SignUpThree extends JFrame implements ActionListener  {
    ...
    SignUpThree(String formno){
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-6203");
        ...
        JLabel pindetail = new JLabel("Your 4 Digit Passoword");
        pindetail.setFont(new Font("Raleway", Font.BOLD,12));
        pindetail.setBounds(100,400, 300, 20);
        add(pindetail);
        
        JLabel services = new JLabel("Sevices Required :");
...
//            String pinnumber = ""+rand.nextInt(9000) + 1000;
            int pin = rand.nextInt(9000) + 1000; // Generates a number between 1000 and 9999
